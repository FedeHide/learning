nombre_1 = input('Comparemos las edades de 2 personas... Dime el nombre de la primera persona: ')
...
if edad_nombre_1 > edad_nombre_2:
    print(f'{nombre_1} es mayor a {nombre_2}, tiene {edad_nombre_1 - edad_nombre_2} años más.')
elif edad_nombre_1 < edad_nombre_2:
    print(f'{nombre_2} es mayor a {nombre_1}, tiene {edad_nombre_2 - edad_nombre_1} años más.')
else:
